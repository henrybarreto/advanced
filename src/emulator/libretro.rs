...
pub const retro_language_RETRO_LANGUAGE_BRITISH_ENGLISH: retro_language = 30;
pub const retro_language_RETRO_LANGUAGE_HUNGARIAN: retro_language = 31;
pub const retro_language_RETRO_LANGUAGE_LAST: retro_language = 32;
